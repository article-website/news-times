  ...
  return (
    <div className="w-full max-w-md bg-white rounded-2xl shadow-sm border border-gray-200 p-8">
      <div className="text-center mb-8">
        ...
        <h2 className="text-xl font-semibold text-gray-900">Masuk ke Panel Redaksi</h2>
        <p className="text-sm text-gray-500 mt-1">
          Masukkan email dan kata sandi administrator Anda untuk mengelola artikel berita.
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        >
          ...
          <span>{isPending ? "Memproses..." : "Masuk ke Panel Admin"}</span>
        </button>
      </form>
